...
2. Upload [train.csv](https://github.com/reharabi/Disaster-Tweets-NLP-Project/blob/main/train%20(1).csv) or from the [Kaggle competition](https://www.kaggle.com/competitions/nlp-getting-started) to your Google Drive
